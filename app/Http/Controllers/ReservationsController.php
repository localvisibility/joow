...
class ReservationsController extends Controller
{
    ...
    public function updateTable(Request $request, Reservation $reservation)
    {
        ...
        $reservation->update($request->validate(['status' => ['required', 'in:pending,confirmed,seated,cancelled,noshow']]));

        return back();
    }

    public function updateStay(Request $request, RoomBooking $booking)
    {
